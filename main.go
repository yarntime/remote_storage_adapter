...
func parseFlags() *config {
	...
	flag.StringVar(&cfg.elasticsearchIndex, "elasticsearch-index", "prometheus",
		"The name of the index to use for storing samples in Elasticsearch.",
	)
	flag.StringVar(&cfg.elasticsearchType, "elasticsearch-type", "prometheus",
		"The name of the type to use for storing samples in Elasticsearch.",
	)
